  ...
  if (existing[0]) {
    await query(
      `UPDATE site_settings SET
        ...
        popup_enabled = ?, popup_headline = ?, footer_credit = ?, footer_credit_url = ?,
    ...
    await query(
      `INSERT INTO site_settings
        (site_name, hero_headline, hero_subheadline, hero_image_url, logo_url, phone, email, secondary_email,
         register_cta_label, popup_enabled, popup_headline, footer_credit, footer_credit_url,
